					...
					<div class="form-group">
						...
						<div class="col-xs-6">
							<select name="qw" id="qw" class="form-control">
								...
								<option value="id">교육 컨텐츠 코드</option>
								<option value="name">사용자</option>
								<option value="department">내용</option>
								<option value="phone">답변 유무</option>
							</select>
						</div>
						<div class="col-xs-17">
			...
			<div class="widget-body data-tbl">
			    <table class="table table-striped table-bordered table-hover data-list">
			        ...
			        <tr>
						<th></th>
						<th>번호</th>
						<th class="col-sort" data-sort="evaluation">내용</th>
						...
						<th class="col-sort" data-sort="score">점수</th>
						<th>관리</th>
			        </tr>
			        </thead>
					<tbody>
